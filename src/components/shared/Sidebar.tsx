...
const Sidebar = () => {
  ...
  return (
    <div className={`fixed left-0 top-14 h-[calc(100vh-3.5rem)] bg-gray-900 transform transition-transform duration-200 ease-in-out ${isOpen ? 'w-64' : 'w-16'} z-40`}>
      <div className="p-2 space-y-4">
        <div className="space-y-2">
          <Link to="/home" className="flex items-center gap-2 text-white px-3 py-2 rounded-lg bg-gray-800">
          ...
          <a href="#" className="flex items-center gap-2 text-gray-400 hover:text-white px-3 py-2 rounded-lg hover:bg-gray-800">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="space-y-2">
          <h3 className={`text-gray-400 font-medium px-3 transition-opacity duration-200 ${isOpen ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'}`}>Explore</h3>
          <a href="#" className="flex items-center gap-2 text-gray-400 hover:text-white px-3 py-2 rounded-lg hover:bg-gray-800">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
