...
import { getFirestore, doc as firestoreDoc, getDoc, updateDoc, arrayUnion, arrayRemove } from "firebase/firestore";
...
const ProjectDetails = () => {
  ...
  const userId = user ? user.uid : null; // Use the currently logged-in user's ID (from Firebase Auth)
  ...
  useEffect(() => {
    const fetchProject = async () => {
      ...
      try {
        ...
        const docRef = firestoreDoc(db, "projects", id);
